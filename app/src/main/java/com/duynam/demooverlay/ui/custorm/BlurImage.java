...
public class BlurImage {
    ...
    public static BlurImage blurFromBitmap(Bitmap bitmap) {
...
//                });
    ...
    public static void into(final ImageView imageView) {
        //imageView.setImageBitmap(new BitmapDrawable(thiscontext.getResources(), blurFillImage));
        Glide.with(imageView.getContext()).asBitmap().load(blurFillImage).into(new CustomTarget<Bitmap>() {
            @Override
